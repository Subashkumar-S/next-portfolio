...
import { Button } from "./MagicButton";
...
export const BentoGridItem = ({
  ...
  const rightLists = ["NodeJS", "ExpressJS", "NextJS", "MongoDB"];
  ...
  const handleCopy = () => {
    const text = "subashkumar.senthil@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-extralight md:max-w-32 md:text-base lg:text-lg text-sm text-white z-10">
            {description}
          </div>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              <div
                className={`absolute -bottom-5 right-0 rounded-md h-8 md:h-8 ${copied ? "block" : "block"
                  }`}
              >
